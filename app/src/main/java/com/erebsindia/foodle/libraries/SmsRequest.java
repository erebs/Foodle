...
public class SmsRequest extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... urls) {
        ...
        String url = "http://sms.erebs.in/api/sms_api.php?username=foodlemart&api_password=s7805jqsbvr&type=2&template_id=1207164010897657656"+urlSuffix;
        Log.i("SMS Data", url);
